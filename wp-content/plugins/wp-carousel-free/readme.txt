...
* Improved: Sanitize product image title attribute.
...
* Fix: The style issue of rating star with storefront theme.
* Tested: WordPress 6.5.2 compatibility.
* Tested: WooCommerce 8.8.3 compatibility.

= 2.6.4 – Apr 05, 2024 =
* Improved: The plugin security improved.
* Improved: The horizontal alignment of the images is set to center aligned in the image carousel.
